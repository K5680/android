package com.example.vesada.indooratlasmaps;
...
public class MapsActivity extends FragmentActivity implements IALocationListener, OnMapReadyCallback  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MapFragment mMap = (MapFragment) getFragmentManager().findFragmentById(R.id.kartta);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.moveCamera(CameraUpdateFactory.newLatLng(jamk));

        Toast.makeText(getApplicationContext(), "kamera siirtyy...  "+mMap, Toast.LENGTH_SHORT).show();
