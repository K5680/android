...
public class AddProductListFragment extends ListFragment {
        ...
        builder.setView(dialogView)
                ...
                .setPositiveButton("Add", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        EditText editPrice = (EditText) dialogView.findViewById(R.id.count);
                        int price = Integer.valueOf(editPrice.getText().toString());

                        // Send the positive button event back to the host activity
                        mListener.onDialogPositiveClick(AddProductListFragment.this,product,count,price);
                    }
                })
                .setNegativeButton("Cancel", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        // Send the negative button event back to the host activity
                        mListener.onDialogNegativeClick(AddProductListFragment.this);
                    }
                });
